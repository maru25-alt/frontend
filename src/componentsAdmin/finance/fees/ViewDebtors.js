...
import Search from "./SearchDebtors";
import Table from "./DebtorsTable";
import axios from "../../../store/axios";
import Excel from "../../../shared/tables/ExcelExport";
...
function DebtorsList() {
  ...
  const handleSearch = () => {
    setloading(true);
    let bal = () => {
      return Object.values(fees).reduce((t, v) => Number(t) + Number(v), 0);
    };
